...
import static com.gurusankar149.cuckoo.Database.allVideoList;
...
public class AllExistingVideosAdapter extends RecyclerView.Adapter<AllExistingVideosAdapter.ViewHolder> {
    ...
    /*    MediaPlayer mediaPlayer = MediaPlayer.create(holder.thumbnail.getContext(), Uri.fromFile(allVideoList.get(position)));
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(holder.thumbnail.getContext(), UploadExistVideo.class);
